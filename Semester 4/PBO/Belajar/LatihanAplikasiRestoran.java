...
public class LatihanAplikasiRestoran {
    public static void main(String[] args) {
        
        keluar: while (true) {
            Scanner input = new Scanner(System.in);
            int pilih, harga = 0;
            String menu1 = null, menu2 = null, menu3 = null, menu4 = null;
             ...
             while (true) {
                ...
                if (pilih == 1) {
                    ...
                    System.out.print("Pilihan Menu Adalah: ");
                        ...
                        System.out.println("");
                    System.out.println("Total Yang Harus Dibayar Adalah Rp. " +harga);
                    ...
                    System.out.println("Uang Kembalian Anda Adalah Rp. " +kembalian);
                    break;
                } else if (pilih == 6) {
                    System.out.println("Anda Telah Keluar Dari Aplikasi");
                    break keluar;
                } else {
                    System.out.println("Pilihan Tidak Valid Mohon Pilih Menu Anda!");
                }
            }
        }
    }
